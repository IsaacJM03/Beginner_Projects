...
/* auth/login.twig */
class __TwigTemplate_aa151f266b214efe17b4ecef3918fedf extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 22
        echo ((twig_get_attribute($this->env, $this->source, ($context["errors"] ?? null), "email", [], "any", false, false, false, 22)) ? ("is-invalid") : (""));
        echo "\"
                                               value=\"";
        // line 23
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["old"] ?? null), "email", [], "any", false, false, false, 23), "html", null, true);
        echo "\"
                                               placeholder=\"Email\"
                                               required />
                                        <div class=\"invalid-feedback\">
                                            ";
        // line 27
        echo twig_escape_filter($this->env, twig_first($this->env, twig_get_attribute($this->env, $this->source, ($context["errors"] ?? null), "email", [], "any", false, false, false, 27)), "html", null, true);
        echo "
                                        </div>
                                    </div>
        ...
        // line 31
        echo ((twig_get_attribute($this->env, $this->source, ($context["errors"] ?? null), "password", [], "any", false, false, false, 31)) ? ("is-invalid") : (""));
        echo "\"
                                               placeholder=\"Password\" required />
                                        <div class=\"invalid-feedback\">
                                            ";
        // line 34
        echo twig_escape_filter($this->env, twig_first($this->env, twig_get_attribute($this->env, $this->source, ($context["errors"] ?? null), "password", [], "any", false, false, false, 34)), "html", null, true);
        echo "
                                        </div>
                                    </div>
...
";
    ...
    {
        return array (  106 => 34,  100 => 31,  93 => 27,  86 => 23,  82 => 22,  76 => 19,  68 => 14,  58 => 6,  54 => 5,  47 => 3,  36 => 1,);
    }
